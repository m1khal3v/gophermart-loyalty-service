...
**gophermart-loyalty-service** - микросервис отвечающий за бонусную систему маркетплейса gophermart,
...
| -          | validator     | Валидация данных (алгоритм Луна, положительное число), интеграция с [govalidator](https://github.com/asaskevich/govalidator) |
